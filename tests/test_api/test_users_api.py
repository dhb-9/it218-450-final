...
# Test user creation access control
@pytest.mark.asyncio
...
# Test user retrieval access control
@pytest.mark.asyncio
...
# Test admin access to user details
@pytest.mark.asyncio
...
# Test updating user email with denial and approval scenarios
@pytest.mark.asyncio
...
# Test user deletion and non-existent user scenarios
@pytest.mark.asyncio
...
# Test user registration with duplicate email and invalid email format
@pytest.mark.asyncio
...
# Test updating user social profiles
@pytest.mark.asyncio
